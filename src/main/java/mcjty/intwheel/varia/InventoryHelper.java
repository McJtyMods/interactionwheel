...
//        world.func_147453_f(x, y, z, block);
    ...
    public void setNewCount(int newcount) {
        this.count = newcount;
        NonNullList<ItemStack> newstacks = NonNullList.withSize(newcount, ItemStack.EMPTY);
            ...
            while (itemsToPlace > 0 && (k < stop)) {
                ...
                if (isItemStackConsideredEqual(result, itemstack1) && (sidedInventory == null || sidedInventory.canInsertItem(k, result, side))) {
                    ...
                    if (l <= result.getMaxStackSize()) {
                        ...
                        itemstack1.setCount(result.getMaxStackSize());
                        inventory.markDirty();
                    }
                }
    ...
    public static void compactStacks(NonNullList<ItemStack> stacks, int start, int max) {
