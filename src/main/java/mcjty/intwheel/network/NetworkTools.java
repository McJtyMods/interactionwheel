...
public class NetworkTools {
    ...
    public static FluidStack readFluidStack(ByteBuf dataIn) {
        ...
        try {
            ...
            InteractionWheel.setup.getLogger().log(Level.ERROR, "Error reading fluid stack", e);
        }
        return null;
    }
    ...
    public static void writeFluidStack(ByteBuf dataOut, FluidStack fluidStack) {
        ...
        try {
            ...
            InteractionWheel.setup.getLogger().log(Level.ERROR, "Error writing fluid stack", e);
        }
    }
    ...
    public static NBTTagCompound readTag(ByteBuf dataIn) {
        ...
        try {
            ...
            InteractionWheel.setup.getLogger().log(Level.ERROR, "Error reading tag", e);
        }
        return null;
    }
    ...
    public static void writeTag(ByteBuf dataOut, NBTTagCompound tag) {
        ...
        try {
            ...
            InteractionWheel.setup.getLogger().log(Level.ERROR, "Error writing tag", e);
        }
    }
    ...
    public static ItemStack readItemStack(ByteBuf dataIn) {
        ...
        try {
            ...
            InteractionWheel.setup.getLogger().log(Level.ERROR, "Error reading item stack", e);
        }
    ...
    public static void writeItemStack(ByteBuf dataOut, ItemStack itemStack) {
        ...
        try {
            ...
            InteractionWheel.setup.getLogger().log(Level.ERROR, "Error writing item stack", e);
        }
    }
